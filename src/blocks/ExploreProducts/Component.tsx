              ...
              categories.map((category, index) => {
                ...
                return (
                  <Link
                    key={index}
                    href={category.link || '#'}
                    className={`group flex flex-col flex-none bg-white rounded-md border border-gray-100 overflow-hidden hover:border-primary/50 transition-all duration-300 relative
                      w-[calc(50%-0.375rem)] sm:w-[calc(50%-0.5rem)] md:w-[calc(33.3333%-1rem)] lg:w-[calc(25%-1.125rem)]
                      ${
                        isMobileCarousel
                          ? 'snap-start'
                          : isDesktopCarousel
