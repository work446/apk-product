...
export const TopBanner = async ({ locale = 'en' }: { locale?: 'en' | 'vi' }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-[60] bg-primary text-primary-foreground py-2 px-4 text-xs md:text-sm font-medium">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0">
        ...
        <div className="hidden md:flex items-center gap-2 tracking-wide uppercase">
